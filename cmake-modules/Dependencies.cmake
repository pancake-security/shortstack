...
set(SPDLOG_CXX_FLAGS "${EXTERNAL_CXX_FLAGS}")
set(SPDLOG_C_FLAGS "${EXTERNAL_C_FLAGS}")
set(SPDLOG_PREFIX "${PROJECT_BINARY_DIR}/external/spdlog")
set(SPDLOG_CMAKE_ARGS "-Wno-dev"
        "-DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER}"
        "-DCMAKE_C_COMPILER=${CMAKE_C_COMPILER}"
        "-DCMAKE_CXX_FLAGS=${SPDLOG_CXX_FLAGS}"
        "-DCMAKE_C_FLAGS=${SPDLOG_C_FLAGS}"
        "-DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE}"
        "-DCMAKE_INSTALL_PREFIX=${SPDLOG_PREFIX}"
        )
set(SPDLOG_INCLUDE_DIR "${SPDLOG_PREFIX}/include")
set(SPDLOG_STATIC_LIB_NAME "${CMAKE_STATIC_LIBRARY_PREFIX}spdlog")
set(SPDLOG_LIBRARY "${SPDLOG_PREFIX}/lib/${SPDLOG_STATIC_LIB_NAME}${CMAKE_STATIC_LIBRARY_SUFFIX}")
...
message(STATUS "spdlog static library: ${SPDLOG_LIBRARIES}")