    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I64) {
          xfer += iprot->readI64(this->successor_seq);
          this->__isset.successor_seq = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t block_request_service_resend_pending_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("successor_seq", ::apache::thrift::protocol::T_I64, 2);
  xfer += oprot->writeI64(this->successor_seq);
  xfer += oprot->writeFieldEnd();
...
block_request_service_fetch_seq_args::~block_request_service_fetch_seq_args() throw() {
}


uint32_t block_request_service_fetch_seq_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t block_request_service_fetch_seq_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("block_request_service_fetch_seq_args");
...
block_request_service_fetch_seq_pargs::~block_request_service_fetch_seq_pargs() throw() {
}


uint32_t block_request_service_fetch_seq_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("block_request_service_fetch_seq_pargs");
...
block_request_service_fetch_seq_result::~block_request_service_fetch_seq_result() throw() {
}


uint32_t block_request_service_fetch_seq_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t block_request_service_fetch_seq_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("block_request_service_fetch_seq_result");
...
block_request_service_fetch_seq_presult::~block_request_service_fetch_seq_presult() throw() {
}


uint32_t block_request_service_fetch_seq_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void block_request_serviceClient::resend_pending(const int32_t block_id, const int64_t successor_seq)
{
  send_resend_pending(block_id, successor_seq);
  recv_resend_pending();
}

void block_request_serviceClient::send_resend_pending(const int32_t block_id, const int64_t successor_seq)
{
  int32_t cseqid = 0;
  ...
  args.block_id = &block_id;
  args.successor_seq = &successor_seq;
  args.write(oprot_);
...
int64_t block_request_serviceClient::fetch_seq(const int32_t block_id)
{
  send_fetch_seq(block_id);
  return recv_fetch_seq();
}

void block_request_serviceClient::send_fetch_seq(const int32_t block_id)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("fetch_seq", ::apache::thrift::protocol::T_CALL, cseqid);

  block_request_service_fetch_seq_pargs args;
  args.block_id = &block_id;
  args.write(oprot_);
...
int64_t block_request_serviceClient::recv_fetch_seq()
{
  ...
  if (fname.compare("fetch_seq") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  int64_t _return;
  block_request_service_fetch_seq_presult result;
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "fetch_seq failed: unknown result");
}
...
void block_request_serviceProcessor::process_resend_pending(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->resend_pending(args.block_id, args.successor_seq);
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
...
void block_request_serviceProcessor::process_fetch_seq(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("block_request_service.fetch_seq", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "block_request_service.fetch_seq");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "block_request_service.fetch_seq");
  }

  block_request_service_fetch_seq_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "block_request_service.fetch_seq", bytes);
  }

  block_request_service_fetch_seq_result result;
  try {
    result.success = iface_->fetch_seq(args.block_id);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "block_request_service.fetch_seq");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("fetch_seq", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "block_request_service.fetch_seq");
  }

  oprot->writeMessageBegin("fetch_seq", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "block_request_service.fetch_seq", bytes);
  }
}
...
void block_request_serviceConcurrentClient::resend_pending(const int32_t block_id, const int64_t successor_seq)
{
  int32_t seqid = send_resend_pending(block_id, successor_seq);
  recv_resend_pending(seqid);
}

int32_t block_request_serviceConcurrentClient::send_resend_pending(const int32_t block_id, const int64_t successor_seq)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("resend_pending", ::apache::thrift::protocol::T_CALL, cseqid);
...
int64_t block_request_serviceConcurrentClient::fetch_seq(const int32_t block_id)
{
  int32_t seqid = send_fetch_seq(block_id);
  return recv_fetch_seq(seqid);
}

int32_t block_request_serviceConcurrentClient::send_fetch_seq(const int32_t block_id)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("fetch_seq", ::apache::thrift::protocol::T_CALL, cseqid);
...
int64_t block_request_serviceConcurrentClient::recv_fetch_seq(const int32_t seqid)
{
